...
def get_housing_data(fileName):
    ...
    readFile = io.open('../datafiles/SFPermitData/Split/splits_4/'+fileName, 'r', encoding='windows-1252')
...
if __name__ == '__main__':
    ...
    pool.map(get_housing_data, [f for f in os.listdir('../datafiles/SFPermitData/Split/splits_4')])
